    ...
    return (
        <View style={styles.container}>
            <ImageBackground source={VoteBackground} style={styles.backgroundContainer}>
                ...
                <TouchableOpacity onPress={() => renderModal(true, 'T')} style={[styles.voteTrumpPositionStyle, elementVisible]} >
                    <Image source={tickBtn}>
                    </Image>
                </TouchableOpacity>
                <TouchableOpacity onPress={() => renderModal(true, 'B')} style={[styles.voteBidenPositionStyle, elementVisible]}>
                    <Image source={tickBtn}>
                    </Image>
                </TouchableOpacity>
            </ImageBackground>
